...
| Credenziale GitHub Review Agent | GitHub App **distinta** da quella del Dev Agent, installata sullo stesso repository con i soli permessi necessari a leggere la pull request e inviare una review. App ID e Installation ID non sono segreti e vivono nella configurazione fuori dal repository; la private key PEM resta fuori dal repository, dai log e dal runtime del modello |
