...
the Review Agent contract exactly. Publish one structured A1-F4 comment and vote on the pull
request. Do not modify code, merge, access Fabric, or retrieve missing evidence from Fabric.